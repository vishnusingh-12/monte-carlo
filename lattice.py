...
class Lattice:
    ...
    def delta_e(self, initial_pos, final_pos, lattice):
        ...
        # initial energy of the ion according to ising model
        initial_energy = sum(self.epsilon * values_of_initial_neighbours)
        ...
        # calculating final energy of the ion according to the ising model
        final_energy = sum(self.epsilon * values_of_final_neighbours)
