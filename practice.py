...
#     diff.append(get_diffusivity(x, np.load(f'40x40_T=1300_r=1.5/vacancy_{i}_metro_ep_1.5.npy')))
# np.save('diffusivity_data/40X40_T=1300_diffusivity_metro_1.5.npy', diff)
