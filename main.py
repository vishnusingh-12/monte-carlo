...
# Creating Lattice Class Object of 20x20, vacancy, epsilon= interaction term
lattice = Lattice(20, 0.1, epsilon)
    ...
    for ion in ions:
        ...
        # if ion not found at potential position
            ...
            # if delta e is greater than 0
                ...
                # generate a random number between 0 and 1 and compare exp(-beta*epsilon)

                # if random number is less than or equal to exp(-beta*epsilon)
...
msd = get_msd(ions, 500)  # original msd calculation

# saving msd to file
np.save(f'vacancy_{10}_metro.npy', msd)
