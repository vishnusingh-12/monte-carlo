    ...
    for i in range(mc_steps):
        ...
        for ion in ions:
            ...
            if lat_2d[potential_pos[0], potential_pos[1]].value == 0:
                ...
                continue
    ions = lattice.get_ions(lat_2d)
    # x = [i[1] for i in ions[0].position_list]
    # y = [i[0] for i in ions[0].position_list]
    # x1 = [i[1] for i in ions[1].position_list]
    # y1 = [i[0] for i in ions[1].position_list]
    # x2 = [i[1] for i in ions[2].position_list]
    # y2 = [i[0] for i in ions[2].position_list]
    # x3= [i[1] for i in ions[-1].position_list]
    # y3 = [i[0] for i in ions[-1].position_list]
